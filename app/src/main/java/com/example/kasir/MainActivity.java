...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnresetdata = (Button) findViewById(R.id.tombol2);
        ...
        btnproses.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //pemberian if dan else untuk pemberian bonus
                ...
                //memberikan action kepada tombol reset data
        ...
        btnresetdata.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //memberikan action kepada tombol keluar
